...
import { SiMariadb, SiTailwindcss, SiPandas, SiNumpy, SiTensorflow, SiArchlinux, SiMaterialdesign } from 'react-icons/si';
...
const skills = [
    ...
    { name: "Arch Linux", icon: <SiArchlinux className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
